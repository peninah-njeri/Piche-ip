...
def index():
    ...
    Diet= Pitch.query.filter_by(category = "Diet")
    Exercise= Pitch.query.filter_by(category = "Exercise")
   
    upvotes = Upvote.get_all_upvotes(pitch_id=Pitch.id)

    return render_template('index.html', title = title, Health=Health, Diet=Diet,Exercise = Exercise,upvotes=upvotes)
